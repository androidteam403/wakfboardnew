...
@Entity(tableName = "polyline_data_table")
...
//    private Marker marker;
    ...
    public PolylineDataTable(double latitude, double longitude, String name, String description, List<String> pointPhotoData) {
